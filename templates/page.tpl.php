    ...
    <!-- End Logo -->
			<div class="snd">
				 <?php if ($site_name || $site_slogan): ?>
					<h1><a href="<?php print $front_page; ?>" id="slogan-site-name"><?php print $site_name; ?></a></h1>
				  <?php endif; ?>
			</div>
   <div class="djlogo">
        <a href="https://www.iitb.ac.in/en/azadi-ka-amrit-mahotsav" target="_blank">
        <img src="<?php print $serverlink;?>/sites/www.ctara.iitb.ac.in/themes/touchm/azadi_g20_logo.png" alt="Azadi ka Amrit Mahostav" /></a>
    </div>
...
<!-- Back To Top -->
<a href="#" class="scrollup"><?php print t('Scroll'); ?></a>
<!-- End Back To Top -->
